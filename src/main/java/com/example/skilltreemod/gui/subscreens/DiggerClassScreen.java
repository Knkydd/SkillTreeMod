...
public class DiggerClassScreen extends ClassesScreen {
    private int availablePoints = 3;
    public DiggerClassScreen(Screen parentScreen) {
        super(parentScreen);
    }
    ...
    private void renderTitle(GuiGraphics guiGraphics) {
        Component title = Component.literal("Шахтер").withStyle(ChatFormatting.BOLD);
