...
public class LibrarianProgressContainer extends ProgressContainer{
    public LibrarianProgressContainer(int x, int y, int width, int height, Screen parentScreen){
