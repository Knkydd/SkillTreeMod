...
public class TankClassScreen extends ClassesScreen {
    private int availablePoints = 3;
    public TankClassScreen(Screen parentScreen) {
        super(parentScreen);
    }
    ...
    private void renderTitle(GuiGraphics guiGraphics) {
        Component title = Component.literal("Танк").withStyle(ChatFormatting.BOLD);
