...
public class FisherClassScreen extends ClassesScreen {
    private int availablePoints = 3;
    public FisherClassScreen(Screen parentScreen) {
        super(parentScreen);
    }
    ...
    private void renderTitle(GuiGraphics guiGraphics) {
        Component title = Component.literal("Рыбак").withStyle(ChatFormatting.BOLD);
