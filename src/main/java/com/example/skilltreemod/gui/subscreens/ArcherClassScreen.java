...
public class ArcherClassScreen extends ClassesScreen {
    private int availablePoints = 3;
    public ArcherClassScreen(Screen parentScreen) {
        super(parentScreen);
    }
    ...
    private void renderTitle(GuiGraphics guiGraphics) {
        Component title = Component.literal("Лучник").withStyle(ChatFormatting.BOLD);
