...
public class LibrarianClassScreen extends ClassesScreen {
    private int availablePoints = 3;
    public LibrarianClassScreen(Screen parentScreen) {
        super(parentScreen);
    }
    ...
    private void renderTitle(GuiGraphics guiGraphics) {
        Component title = Component.literal("Библиотекарь").withStyle(ChatFormatting.BOLD);
